...
public class BurnCotroller : MonoBehaviour {
    ...
    [SerializeField]
    private ParticleSystem.MinMaxCurve emisionCurve;

    [SerializeField]
    private MeshRenderer meshRenderer = null;

    [SerializeField]
    private Transform burnTransform = null;

    [Range(0, 1)]
    [SerializeField]
    public float animationStage = 0f;

    [Range(0, 50)]
    [SerializeField]
    private int emisionMyltiplier = 0;

    [Header("FirsParticleSet")]
    [SerializeField]
    private bool isMoveEmitor;
    [SerializeField]
    ...
    private void Update() {
        ...
        if (isMoveEmitor) {
            Vector3 newPosition = Vector3.Lerp(startPosition, endPosition, animationStage);
